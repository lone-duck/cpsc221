...
// END PA 4 FUNCTIONS
  ...
  private:
    ...
    */
    QuadtreeNode* buildTree(PNG const& source, int local_x0, int local_y0, int local_res);
    ...
    */
    RGBAPixel getPixel(QuadtreeNode* subRoot, int local_x0, int local_y0, int local_res, int x, int y) const;
    ...
    * @param px4
    */
    static RGBAPixel avgPixel(RGBAPixel px1, RGBAPixel px2, RGBAPixel px3, RGBAPixel px4);
    ...
    */
    bool isPrunable(const QuadtreeNode* subRoot, int tolerance) const;


    /**
    * Determines the distance between the colors of two pixels
    */
    int colorDistance(const RGBAPixel& xp1, const RGBAPixel& px2) const;
    ...
    */
    void decompress(QuadtreeNode* subRoot, PNG& image, int local_x0,
    ...
    bool leafCompare(const RGBAPixel& px, const QuadtreeNode* subRoot, int tolerance) const;
